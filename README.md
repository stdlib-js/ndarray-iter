...
```javascript
import { nditer2arrayEach, nditerColumns, nditerEntries, nditerIndices, nditerRows, nditerValues } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-iter@v0.1.0-esm/index.mjs';
```

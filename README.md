...
```javascript
import { nditer2arrayEach, nditerColumns, nditerEntries, nditerIndices, nditerMatrices, nditerRowEntries, nditerRows, nditerValues } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-iter@esm/index.mjs';
```

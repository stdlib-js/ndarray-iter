...
import nditerColumnEntries = require( '@stdlib/ndarray-iter-column-entries' );
...
import nditerInterleaveSubarrays = require( '@stdlib/ndarray-iter-interleave-subarrays' );
import nditerMatrices = require( '@stdlib/ndarray-iter-matrices' );
import nditerMatrixEntries = require( '@stdlib/ndarray-iter-matrix-entries' );
import nditerRowEntries = require( '@stdlib/ndarray-iter-row-entries' );
import nditerRows = require( '@stdlib/ndarray-iter-rows' );
import nditerSelectDimension = require( '@stdlib/ndarray-iter-select-dimension' );
import nditerStacks = require( '@stdlib/ndarray-iter-stacks' );
import nditerSubarrays = require( '@stdlib/ndarray-iter-subarrays' );
